  ...
  "actions": [
    {      
      "collect": {
        ...
        "questions": [
          {
            "question": "<?= "Para confirmar a reserva de ".$room_type." com entrada dia ".$checkinDate." até ".$checkoutDate." para ".$guests. " pessoas:"; ?> no valor de R$3439,00 escolha a forma de pagamento: Depósito, Cartão ou Boleto",
            "name": "payment_type",
            "type": "Twilio.ALPHANUMERIC"
          }
        ],
        "on_complete": {
          "redirect": "http://194c2831.ngrok.io/bot/choose_payment.php"
        }
      }
